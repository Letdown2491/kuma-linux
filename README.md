...
![Kuma running the niri desktop: a scrollable tiling Wayland session with kitty and fastfetch reporting a read-only overlay root](docs/screenshots/niri.jpg)
